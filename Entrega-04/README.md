# 🐾 ONG ProPet - Versão Final com Acessibilidade e Produção

## Sobre o Projeto

Esta é a **quarta e última entrega** do projeto acadêmico da **ONG ProPet**, implementando práticas profissionais de versionamento, acessibilidade WCAG 2.1 AA e otimização para produção. O projeto demonstra conhecimento avançado em Git/GitHub, desenvolvimento acessível e deploy profissional.

### Evolução do Projeto:
- **Entrega 01**: HTML puro (estrutura básica)
- **Entrega 02**: HTML + CSS (design system e responsividade)
- **Entrega 03**: HTML + CSS + JavaScript (SPA e validações)
- **Entrega 04**: Acessibilidade + GitFlow + Otimização de Produção
